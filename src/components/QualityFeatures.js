...
const QualityFeatures = () => {
  ...
  return (
    <section className="container mx-auto px-5 md:px-16 py-10" id="donate">
      {/* Header Section */}
      ...
      <div className="grid lg:grid-cols-2 gap-6 items-start">
        ...
        <div className="space-y-8">
          <div className="bg-gradient-to-br from-purple-50 to-blue-50 dark:from-gray-800 dark:to-gray-900 rounded-3xl p-4 shadow-lg">
          ...
          <div className="bg-gradient-to-br from-blue-50 to-purple-50 dark:from-gray-800 dark:to-gray-900 rounded-3xl p-4 shadow-lg">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-3">
              <span className="text-4xl">✨</span>
              Our Vision
            </h2>
          ...
          <div className="bg-gradient-to-br from-purple-50 to-pink-50 dark:from-gray-800 dark:to-gray-900 rounded-3xl p-4 shadow-lg">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-3">
              <span className="text-4xl">🌍</span>
